...
const OTRequests = () => {
  ...
  // Own late/office-time-change requests, for the Late Time log
  ...
  useEffect(() => {
    ...
    fetchLateRequests();
  }, [fetchRequests, fetchPendingRequests, fetchLateRequests]);
    ...
    <div className="space-y-6">
      <Tabs defaultValue="overtime">
        <TabsList>
          ...
          <TabsTrigger value="late">Late Time</TabsTrigger>
        ...
        <TabsContent value="overtime" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Overtime Log</CardTitle>
              <CardDescription>Every overtime request you've submitted.</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="late" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Late Time Log</CardTitle>
              <CardDescription>Every office-time-change request you've submitted.</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {myLateRequests.length === 0 ? (
                    <TableRow><TableCell colSpan={5} className="text-center text-muted-foreground">No requests</TableCell></TableRow>
                  ) : myLateRequests.map((req) => (
                    <TableRow key={req.id}>
        ...
        {/* ===== Leave segment — the full Leave Management page, moved here ===== */}
