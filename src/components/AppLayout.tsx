...
import { RoleSimulatorProvider } from "@/components/hrms/RoleSimulatorContext";
import { RoleSimulator } from "@/components/hrms/RoleSimulator";
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <header className="h-14 flex items-center border-b px-2 sm:px-4 justify-between gap-2 bg-card sticky top-0 z-30">
              ...
              <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                <div className="hidden sm:block"><RoleSimulator /></div>
                <NotificationBell />
              </div>
            </header>
